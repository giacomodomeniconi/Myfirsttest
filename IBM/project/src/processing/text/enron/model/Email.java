...
public class Email {
	...
	public Email(int id, int threadid, int senderid,String subject, String text) {
		this.id=id;
	...
	public ArrayList<Integer> getIvolvedUsers(){
		ArrayList<Integer> u=new ArrayList<>(this.getReceiversid());
