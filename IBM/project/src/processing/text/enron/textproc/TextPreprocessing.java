...
public class TextPreprocessing {
	...
	public static ArrayList<Email> createBow(ArrayList<Email> emails, boolean withQuotation, boolean doStemming){
		WordFilters filters=new WordFilters(doStemming);		
		if(withQuotation){
			for(Email e : emails){
	...
	public static ArrayList<Email> createBowAndWeight(ArrayList<Email> emails, boolean withQuotation, boolean doStemming, int minDocFreqPerWord, String dataset_name){
		WordFilters filters=new WordFilters(doStemming);		
		...
		if(withQuotation){
			...
			try{
				PrintWriter pw=new PrintWriter(dataset_name+"_idfMap.txt");
