...
public class Enron {
	...
	public Enron () throws IOException, SQLException, ClassNotFoundException {
		...
		connect = DriverManager.getConnection("jdbc:mysql://shadow.cs.uoi.gr:3306/enron_new", "ksemer", "10101990");
					...
					while ((line = br.readLine()) != null) {
						if (flag) {
							if (line.contains("X-") || line.isEmpty() || !line.matches(".*\\w.*")
								/*	|| line.contains("To:") || line.contains("cc") 
									|| line.contains("Subject")
									|| line.contains("Forwarded by")
									|| line.contains("--") || line.contains(" AM") 
									|| line.contains(" PM")*/)
								continue;
							body+=line + "\n";
						}
